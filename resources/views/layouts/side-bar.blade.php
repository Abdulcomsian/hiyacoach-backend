            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link  {{ Request::is('payment*') ? 'active' : '' }}"
                        href="{{ route('payment_transactions.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                    viewBox="0 0 24 24" version="1.1">
                ...
                <div class="menu-item">
                    <a class="menu-link  {{ Request::is('insurance*') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('packages*') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('sanction*') ? 'active' : '' }}"
                        href="{{ route('sanction_request.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                    viewBox="0 0 24 24" version="1.1">
